...
const Header = () => {
  ...
  return (
    <header
      className={`${headerScrolled ? "py-4 shadow-lg" : "py-6 lg:py-5"
    ...
    >
      <div className="container mx-auto flex items-center justify-between">
        ...
        {/* Navigation */}
        <nav
          className={`${menuOpen ? "top-[120px] right-0 bg-transparent" : "top-0 -left-full bg-transparent"
...
const NavItem = ({ text, onClick, headerScrolled }) => (
  <div
    className={`block lg:inline-block py-4 lg:py-0 hover:text-red-400 transition cursor-pointer text-xl font-bold ${headerScrolled ? "text-red-700 lg:blue-red-700" : "text-red-700 lg:text-red-700"
      }`}
    onClick={onClick}
  >
    {text}
