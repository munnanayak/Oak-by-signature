...
const Gallery = () => {
  ...
  return (
    <div>
      ...
      <div className={`max-w-screen-lg mx-auto ${headerScrolled ? 'pt-40' : 'pt-32'} py-8 text-center`}>
        {/* Adjusted padding-top for the heading */}
            ...
            <div className="p-4 border rounded-lg hover:shadow-lg transition-shadow duration-300 w-full">
              <div onClick={() => openModal([room1Img1, room1Img2, room1Img3, room2Img1, room2Img2, room2Img3, room3Img1, room3Img2, room3Img3, room10Img1, room11Img1, room20Img1, room21Img1, room12Img1, room13Img1, room14Img1, room15Img1, room16Img1, room17Img1, room22Img1, room23Img1, room24Img1])} className="cursor-pointer">
                <div className="relative">
                  <img src={room1Img1} alt="All Images" className="object-cover w-full h-64 md:h-80 lg:h-96 rounded-lg" />
            ...
            <GallerySection
              openModal={(roomType) => {
                if (roomType === 'suit') {
                  ...
                  openModal([room2Img2, room2Img1, room2Img3]);
                } else if (roomType === 'superior') {
                  openModal([room2Img3, room3Img1, room3Img2, room3Img3]);
                }
              }}
      ...
      <Modal
        ...
        className={`fixed inset-0 flex items-start justify-center p-6 bg-gray-1100 bg-opacity-85 ${modalPosition === 'bottom' ? 'bottom-0' : ''} mt-20`} // Adjust modal top margin for better visibility
          ...
          >
            ...
            {modalImages.map((img, index) => (
              <SwiperSlide key={index}>
                <img src={img} alt={`Room gallery ${index + 1}`} className="object-cover w-full h-64 md:h-80 lg:h-96 rounded-lg" />
              </SwiperSlide>
            ))}
          </Swiper>
        </div>
...
const ToggleButton = ({ text, isSelected, onClick }) => (
  <button
    className={`text-lg font-bold py-2 px-4 flex items-center justify-center hover:text-red-400 transition-colors ${isSelected ? 'text-red-400' : 'text-gray-700'
      }`}
    onClick={onClick}
  >
    {text}
...
const PropertySection = ({ openModal }) => (
  <div className="p-4 border rounded-lg hover:shadow-lg transition-shadow duration-300 w-full">
    <div onClick={openModal} className="cursor-pointer">
      <div className="relative">
        <img src={room10Img1} alt="Property Images" className="object-cover w-full h-64 md:h-80 lg:h-96 rounded-lg" />
        <div className="absolute bottom-0 left-0 p-4 text-white">
...
const WashroomSection = ({ openModal }) => (
  <div className="p-4 border rounded-lg hover:shadow-lg transition-shadow duration-300 w-full">
    <div onClick={openModal} className="cursor-pointer">
      <div className="relative">
        <img src={room22Img1} alt="Washroom Images" className="object-cover w-full h-64 md:h-80 lg:h-96 rounded-lg" />
        <div className="absolute bottom-0 left-0 p-4 text-white">
...
const RestaurantSection = ({ openModal }) => (
  <div className="p-4 border rounded-lg hover:shadow-lg transition-shadow duration-300 w-full">
    <div onClick={openModal} className="cursor-pointer">
      <div className="relative">
        <img src={room12Img1} alt="Restaurant Images" className="object-cover w-full h-64 md:h-80 lg:h-96 rounded-lg" />
        <div className="absolute bottom-0 left-0 p-4 text-white">
      ...
      <div className="w-full lg:w-1/2">
        <div className="relative">
          <img
            ...
            src={room2Img1}
            alt={`Suit Room`}
            className="object-cover w-full h-64 md:h-80 lg:h-96 rounded-lg cursor-pointer"
          />
